...
import {
  SiJavascript, SiHtml5, SiCss3, SiReact, SiRedux, SiTailwindcss,
  SiBootstrap, SiMongodb, SiMysql, SiDocker,SiExpress,SiCplusplus
} from 'react-icons/si';
import {
  FaJava, FaPython, FaNodeJs, FaGitAlt, FaLinux
} from 'react-icons/fa';
...
const portfolioInfo = {
  ...
  description: "I'm a student at DIT University Dehradun. Currently, I am pursuing an B.Tech in Computer Science. Additionally, I am an experienced Full-Stack Web Developer, I build websites from the ground up.",
  aboutMe: "I'm a creative frontend developer who loves building beautiful and user-friendly web experiences. With a solid background in modern web technologies and a passion for clean design, I bring ideas to life in the browser."
}
const navLinks = [
  {
    name: 'home',
...
const timeline = [
  ...
  // },
  {
    ...
    date: "2022 – Present",
    description: "CGPA: 9.0 – Focused on web development, full-stack projects, and problem solving.",
  },
  {
    type: "education",
    title: "12th Grade – Cambridge Convent School",
    date: "2020 – 2021",
    description: "Scored 93% in CBSE Board with a strong foundation in Mathematics and Computer Science.",
  },
  {
    type: "education",
    title: "10th Grade – Cambridge Convent School",
    date: "2019 – 2020",
    description: "Scored 92% in CBSE Board with academic excellence in Science and Math.",
  },
];
...
const socials = [
  {
    name: 'github',
    url: 'https://github.com/aayanofficial5/',
    icon: <FaGithub />,
  },
  {
    name: 'facebook',
    url: 'https://www.facebook.com/people/Aayan-Patel/100057310502325/',
    icon: <FaFacebookF />,
  },
  {
    name: 'linkedin',
    url: 'https://linkedin.com/in/aayanofficial5186',
    icon: <FaLinkedinIn />,
  },
  {
    name: 'instagram',
...
const languages = [
  {
    name: 'C',
    icon: <img src="https://img.icons8.com/?size=100&id=40670&format=png&color=000000" className='h-10'/>,
    tag: 'skill',
    desc: 'C is a general-purpose programming language ideal for system-level programming and embedded development.',
  },
  {
    name: 'C++',
    icon: <img src="https://raw.githubusercontent.com/isocpp/logos/master/cpp_logo.png" className='h-10'/>,
    tag: 'skill',
...
export {portfolioInfo, navLinks, projects, socials, languages, timeline
  //  projects 
  };
